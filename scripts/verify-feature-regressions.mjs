...
const checks = [
  ...
  ["workbench More menu exposes share, native opening, properties, and in-place source/preview switching", workbenchSource.includes('this.plugin.t("documentShare")') && workbenchSource.includes('this.plugin.t("documentOpenInObsidian")') && workbenchSource.includes('this.plugin.t("documentProperties")') && workbenchSource.includes('this.plugin.t("documentBackToPreview")') && workbenchSource.includes('void this.switchDocumentMode(sourceMode ? "preview" : "markdown")') && source.includes("openDocumentWithObsidianDefault(file: TFile)") && source.includes("registeredOwner === CANCIP_DOCUMENT_VIEW_TYPE")],
  ...
  ["workbench NoteDraw horizontal coordinates follow iframe scrolling", source.includes('event.data.type === "scroll"') && source.includes("this.noteDrawScrollLeft = left") && source.includes("this.noteDrawContentWidth") && source.includes("event.clientX - (rect?.left ?? 0) + this.noteDrawScrollLeft")],
