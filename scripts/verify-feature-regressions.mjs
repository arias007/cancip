...
const checks = [
  ...
  ["context edit preserves native selection copy menus", source.includes("Keep Obsidian/Android's native selection toolbar") && source.includes('if (contextAnchor.kind !== "selection")') && source.includes('if (anchor.kind !== "selection")')],
  ["blank-caret context edit stays unmarked until a proposal is ready", source.includes("private showContextEditInputMarker") && source.includes('if (anchor.kind === "blank-caret")') && source.includes("showContextEditInputMarker(effectiveAnchor, true)") && source.includes("showContextEditMarker(effectiveAnchor, false, this.contextualEditProposalPreviewText(proposal))")],
