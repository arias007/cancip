...
const checks = [
  ...
  ["inline workbench keeps NoteDraw webview wand beside the embed instead of Markdown actions", source.includes('head.className = "obcc-inline-workbench-embed-head mwv-note-actions"') && source.includes("NoteDraw uses this integration host for webview actions")],
