...
const checks = [
  ...
  ["inline workbench preview is excluded from NoteDraw webview discovery without changing the Markdown wand", inlineEmbedSource.includes('head.className = "obcc-inline-workbench-embed-head"') && !inlineEmbedSource.includes("mwv-note-actions") && inlineEmbedSource.includes('className = "obcc-inline-workbench-embed-frame-host notedraw-toolbar"') && inlineEmbedSource.includes('data-cancip-notedraw-excluded') && inlineEmbedSource.includes("actual NoteDraw wand remains available")],
