...
- PrimeTTS is the single default playback route for both Chinese and English. Paired source/spoken chunks keep original digits for display/highlight while applying language-aware number conversion, and decoded look-ahead reduces playback gaps.
